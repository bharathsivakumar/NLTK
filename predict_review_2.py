...
def estimate_learning_curves_Naive_Bayes(training_data_df, testing_data_df):
    """
    Returns the final trained Naive Bayes estimator
    trained on the entier training set as well as 
    the accuracy of the model on the training and test 
    datasets with increasing training set size 
    as well as the predicted labels for the training dataset as a list 
    and the actual labels of the training dataset as a list 
...
def plot_learning_curves(train_score, test_score, training_set_sizes, suptitle='Learning curve of a Naive Bayes Classifier', title='Estimating sentiment of a movie review', xlabel='Size of training dataset', ylabel='Accuracy'):
